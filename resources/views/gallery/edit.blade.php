        ...
        <div class="container">
            <form method="post" action="/admin/gallery/update/{{ $gallery->id }}" enctype="multipart/form-data">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" name="name" type="text" placeholder="Nama objek" value="{{ $gallery->name }}">
                    </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" name="address" type="text" placeholder="Alamat objek" value="{{ $gallery->address }}">
                    </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" name="long" type="text" placeholder="Alamat objek" value="{{ $gallery->long }}">
                    </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" name="lat" type="text" placeholder="Alamat objek" value="{{ $gallery->lat }}">
                    </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <textarea class="textarea" name="information" placeholder="Textarea">{{ $gallery->information }}</textarea>
                    </div>
